...
import 'package:navisafe_app/services/collision_detection_service.dart';

void main() {
  testWidgets('NaviSafe app launches successfully', (WidgetTester tester) async {
  ...
  testWidgets('Safety alerts widget displays correctly', (WidgetTester tester) async {
